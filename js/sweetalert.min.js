!(function (e, t) {
	...
	const $t = (e, t, n) => {
			...
			if (o.length)
				return (
					(t += n) === o.length ? (t = 0) : -1 === t && (t = o.length - 1), o[t].focus()
				);
			g().focus();
		},
		...
		en = (e, n, o) => {
			...
			if (i && !n.isComposing && 229 !== n.keyCode)
				if ((i.stopKeydownPropagation && n.stopPropagation(), 'Enter' === n.key))
					...
					(['textarea', 'file'].includes(t.input) || (Xt(), a.preventDefault()));
				else if ('Tab' !== n.key) {
